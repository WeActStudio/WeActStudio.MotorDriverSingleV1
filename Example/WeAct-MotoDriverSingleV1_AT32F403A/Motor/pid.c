...
// From https://gitee.com/xxpcb/stm32-motor-pid
...
#define LOC_INTEGRAL_MAX_VAL 5000  /*积分范围限定，防止积分饱和*/
...
#define SPE_INTEGRAL_START_ERR 3000 /*积分分离时对应的误差范围*/
#define SPE_INTEGRAL_MAX_VAL 12000  /*积分范围限定，防止积分饱和*/
